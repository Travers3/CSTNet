...
def main():
    ...
    # adj_mx = np.diag([1] * 70)
    dataloader = util.load_dataset_(args.data, args.batch_size, args.batch_size, args.batch_size)
    ...
    if args.model == 'gwnet':
        ...
        engine = trainer6(args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
                           args.learning_rate, args.weight_decay, device, supports, args.decay
                           )
    elif args.model == 'ASTGCN_Recent':
        engine = trainer7(args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
                          args.learning_rate, args.weight_decay, device, supports, args.decay
                          )
...
def tes_model():
    ...
    engine.model.load_state_dict(torch.load("./garage/Oil/Cs/60-2500-1010/ASTGCN_Recent/ASTGCN_Recent_exp1_best_1.66.pth"))
    engine.model.eval()
