...
def generate_train_val_test(args):
    ...
    #df = np.load('D:/Space/Spaceself/HGCN-main/HGCN-main/data/xian/original_data.npz')['data']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--traffic_df_filename", type=str, default="data/original_data.npz", help="Raw traffic readings.",)
    ...
    #print(args)
    #print(generate_train_val_test(args))
